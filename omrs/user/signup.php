...
if($query -> rowCount() == 0)
{
$sql="Insert Into tbluser(userName,MobileNumber,Address,Password)Values(:name,:mobno,:add,:password)";
...
<html lang="en">
 ...
 <form class="form-auth-small" action="" method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="UserName" required="true" name="name" value="" >
            </div><!-- form-group -->
